...
export default function MenuView({ sections, google }) {
  ...
  // Avis : on utilise les vrais avis Google si disponibles, sinon le repli de site.js
  const rRating = google?.rating || SITE.rating;
  const rCount = google?.total ?? SITE.reviewCount;
  const rList = (google?.reviews?.length ? google.reviews : SITE.reviews) || [];
      ...
      <section className="reviews wrap" id="avis">
        ...
        <div className="reviews-head">
          <div className="reviews-score">
            <span className="rscore">{rRating}</span>
            <span className="reviews-stars">★★★★★</span>
            <span className="rcount">{rCount} avis Google</span>
          </div>
            ...
            <div className="review-card" key={i}>
              <div className="rc-top">
                <span className="rc-name">
                  {r.photo && (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img className="rc-ava" src={r.photo} alt="" referrerPolicy="no-referrer" />
                  )}
                  {r.name}
                </span>
              ...
              {r.time && <span className="rc-time">{r.time}</span>}
            </div>
          ))}
        </div>
